...
| 3 — Real DAGs + realtime + Apply to Batch | Object storage/presigned upload, shared recipe package, SSE progress stream, batch dispatch, branching/parallel DAG resolution + dispatch | ✅ Done |
